...
{
    public class NoiseQuadPreviewGenerator : MonoBehaviour
    {
        ...
        {
            NoiseQuadPreviewGenerator[] n = FindObjectsByType<NoiseQuadPreviewGenerator>(FindObjectsSortMode.None); ;
            foreach (NoiseQuadPreviewGenerator go in n)
            {
                go.Compute();
            }
        }
