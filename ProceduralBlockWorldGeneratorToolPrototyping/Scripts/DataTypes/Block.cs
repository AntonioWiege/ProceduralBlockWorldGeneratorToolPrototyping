...
namespace ProceduralBlockWorldGeneratorToolPrototyping
{
    ...
    public class Block
    {
        ...
        /// <summary>The current composition of the blocks total shape, that should be rendered</summary>
        ...
        /// <summary>
        /// check what sides of the block are occluded by it's neighbours; Needs neighbors to be sufficiently generated to address correct, up to date data
        /// </summary>
